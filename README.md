...
Some of these proofs are well known to experts and completely invisible to students. Others are less standard. All of them changed the way I think.

---

## What you will find here

Each proof is a self-contained PDF, typeset in LaTeX with dark background and hand-drawn contour diagrams in TikZ. The level varies — some proofs require only complex analysis, others touch analytic number theory or functional analysis — but every argument is written to be followed line by line, with no steps hidden.

At the end of each proof there is a short note. Not a summary. More like the thought I had when I finally understood what was really going on.

---

## A note on style

I write these proofs the way I wish I had read them. Black background, white ink, diagrams that look like they were drawn on a blackboard at 2am. Mathematics should feel like something.
...
*Each one chosen for beauty, not difficulty.*
